...
public static class SpriteHelper
{
    ...
    public static Sprite LoadSpriteFromResources(this Assembly assembly, string resourcePath, float pixelsPerUnit = 1f)
    {
        try
        {
    ...
    public static Sprite LoadSpriteFromDisk(string filePath, float pixelsPerUnit = 1f)
    {
        try
        {
    ...
    public static Sprite LoadSpriteFromBytes(byte[] bytes, float pixelsPerUnit = 1f)
    {
        try
        {
