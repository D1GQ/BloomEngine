...
/// <summary>
/// Provides utility methods for creating and managing coroutines.
/// </summary>
internal static class CoroutineHelper
{
    ...
    internal static IEnumerator Parallel(params IEnumerator[] coroutines)
    {
        ...
        {
            MelonLogger.Warning($"Parallel coroutine execution exceeded maximum iterations ({maxIterations})");
        }
    }
}